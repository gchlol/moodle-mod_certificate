...
certificate_print_text($pdf, $x, $y + 102, 'C', 'Helvetica', '', 16, 'on');
...
$pdf->SetTextColor(128, 128, 128);
certificate_print_text($pdf, $x, $y + 182, 'C', 'Helvetica', '', 16, 'Presented by');
$pdf->SetTextColor(0, 60, 105);
certificate_print_text($pdf, $x, $y + 190, 'C', 'Helvetica', 'B', 16, 'Gold Coast Health Learning On-Line');
