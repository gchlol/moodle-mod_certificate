...
certificate_print_text($pdf, $x, $y + 28, 'C', 'Helvetica', '', 16, get_string('certify', 'mod_certificate'));
$pdf->SetTextColor(0, 60, 105);
certificate_print_text($pdf, $x, $y + 47, 'C', 'Helvetica', 'B', 32, fullname($USER));
$pdf->SetTextColor(128, 128, 128);
certificate_print_text($pdf, $x, $y + 73, 'C', 'Helvetica', '', 16,
    get_string('completedrequirements', 'mod_certificate'));
certificate_print_text($pdf, $x, $y + 102, 'C', 'Helvetica', '', 16, get_string('on', 'mod_certificate'));

$pdf->SetTextColor(0, 60, 105);
certificate_print_text($pdf, $x, $y + 92, 'C', 'Helvetica', 'B', 16, $course->fullname);
//$pdf->SetTextColor(0, 0, 0);
certificate_print_text($pdf, $x, $y+112, 'C', 'Helvetica', 'B', 16, certificate_get_date($certificate, $certrecord, $course));
$pdf->SetTextColor(128, 128, 128);
certificate_print_text($pdf, $x, $y + 182, 'C', 'Helvetica', '', 16, get_string('presentedby', 'mod_certificate'));
$pdf->SetTextColor(0, 60, 105);
certificate_print_text($pdf, $x, $y + 190, 'C', 'Helvetica', 'B', 16,
...
$i = 0;
 ...
 certificate_print_text($pdf, $custx, $custy, 'L', 'Times', '', 9, $certificate->customtext,130);
?>
