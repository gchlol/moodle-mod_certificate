...
certificate_print_text($pdf, $x, $y + 15, 'C', 'Helvetica', '', 37.5, get_string('coursetheory', 'mod_certificate'));
$pdf->SetTextColor(128, 128, 128);
certificate_print_text($pdf, $x, $y + 44, 'C', 'Helvetica', '', 16, get_string('certify', 'mod_certificate'));
$pdf->SetTextColor(0, 60, 105);
certificate_print_text($pdf, $x, $y + 60, 'C', 'Helvetica', 'B', 32, fullname($USER));
$pdf->SetTextColor(128, 128, 128);
certificate_print_text($pdf, $x, $y + 85, 'C', 'Helvetica', '', 16,
    get_string('completedtheoreticalrequirements', 'mod_certificate'));
$pdf->SetTextColor(0, 60, 105);
...
certificate_print_text($pdf, $x, $y + 126, 'C', 'Helvetica', 'B', 16, get_string('on', 'mod_certificate'));
