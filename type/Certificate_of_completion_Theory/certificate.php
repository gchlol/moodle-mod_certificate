...
certificate_print_text($pdf, $x, $y + 15, 'C', 'Helvetica', '', 37.5, 'course theory');
$pdf->SetTextColor(128, 128, 128);
certificate_print_text($pdf, $x, $y + 44, 'C', 'Helvetica', '', 16, 'This is to certify that');
$pdf->SetTextColor(0, 60, 105);
certificate_print_text($pdf, $x, $y + 60, 'C', 'Helvetica', 'B', 32, fullname($USER));
$pdf->SetTextColor(128, 128, 128);
certificate_print_text($pdf, $x, $y + 85, 'C', 'Helvetica', '', 16, 'has successfully completed the theoretical requirements of');
$pdf->SetTextColor(0, 60, 105);
