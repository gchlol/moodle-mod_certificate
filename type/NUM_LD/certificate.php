...
// Direct care survey_id = 1202
$questionnaire = $DB->get_record('questionnaire', array('id' => 1205));
...
$cell->colspan = 2;
$cell->text = get_string('numleadership', 'mod_certificate');
