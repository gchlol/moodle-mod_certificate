...
certificate_print_text($pdf, $x, $y, 'C', 'Helvetica', '', 37.5, 'Statement of Attainment');
...
$pdf->SetTextColor(128, 128, 128);
certificate_print_text($pdf, $x, $y + 85, 'C', 'Helvetica', '', 16, 'has completed the following course');
$pdf->SetTextColor(0, 60, 105);
