...
// echo html_writer::tag('pre', print_r($result, true));die;
...
if (is_array($result)) {
    ...
    // Get required fields.
    $posds = $DB->get_record('ballot_request_data', array('requestid' => $request->id, 'fieldid' => 9));
    $empsubgroup = $DB->get_record('ballot_request_data', array('requestid' => $request->id, 'fieldid' => 11));
    $orgno = $DB->get_record('ballot_request_data', array('requestid' => $request->id, 'fieldid' => 8));
    $unit = $DB->get_record('ballot_request_data', array('requestid' => $request->id, 'fieldid' => 7));
